...
export const DEFAULT_SETTINGS = Object.freeze({
     ...
     * without knowing which workspace the request acts in.
     */
    workspaceId: "",
    model: "claude-opus-5",
    /** Empty means "use the API default" rather than pinning a level. */
    effort: "",
...
/**
 * Settings writes are serialised.
 *
 * Every update is a read-modify-write of one stored object, so two of them in
 * flight at once both read the same base and the second silently discards the
 * first. That is not hypothetical: ticking the consent box and changing the
 * model in quick succession lost the consent.
 */
